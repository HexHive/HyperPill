...
diff -au $PATH_TO_HYPERPILL_MAIN/enum.cc enum.cc
diff -au $PATH_TO_HYPERPILL_MAIN/feedback.cc feedback.cc
diff -au $PATH_TO_HYPERPILL_MAIN/fuzz.cc fuzz.cc
...
diff -au $PATH_TO_HYPERPILL_MAIN/sourcecov.cc sourcecov.cc
diff -au $PATH_TO_HYPERPILL_MAIN/symbolize.cc symbolize.cc

diff -au $PATH_TO_HYPERPILL_MAIN/bochsapi/apic.cc backends/bochs/apic.cc
